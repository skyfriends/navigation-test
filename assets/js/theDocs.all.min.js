    ...
    propHooks: {
      tabIndex: {
        get: function(a) {
          ...
          return b
            ? parseInt(b, 10)
            : jb.test(a.nodeName) || (kb.test(a.nodeName) && a.href) ? 0 : -1;
        },
      },
    },
    propFix: {
        ...
        if ('php' === e.language) {
          for (var n, a = 0; (n = e.tokenStack[a]); a++)
            e.highlightedCode = e.highlightedCode.replace(
              '{{{PHP' + (a + 1) + '}}}',
              Prism.highlight(n, e.grammar, 'php').replace(/\$/g, '$$$$')
            );
    ...
    Prism.hooks.add('before-highlight', function(s) {
      ...
      if (a && /pre/i.test(a.nodeName)) {
        var t,
          ...
          p = a.previousSibling;
        p &&
        /\s*\bprism-show-language\b\s*/.test(p.className) &&
        p.firstChild &&
        /\s*\bprism-show-language-label\b\s*/.test(p.firstChild.className)
          ? (i = p.firstChild)
...
!(function(a, b) {
  ...
  function d(a) {
    var c = b.Deferred();
    return (
      x ? (a.one(x, c.resolve), setTimeout(c.resolve, 500)) : c.resolve(),
      c.promise()
    );
  }
  ...
  function l(a) {
    ...
    return (
      ...
      c &&
        (d = h(
          f() + '//www.youtube' + (c[2] || '') + '.com/embed/' + c[4],
          b.extend(
            {
              autoplay: 1,
            },
  ...
  function m(a) {
    ...
    function g() {
      var a = n.documentElement.clientHeight
    ...
    function j(a, c) {
      ...
      return (
        e && ((t = b.Deferred()), b.when(k()).done(b.proxy(i, null, d, e, c))),
        !!e
      );
    }
...
$(function() {
  ...
  if ($('.sidenav.sticky').length > 0) {
    var sidenav_max_height =
      $(window).height() - $('.sidenav.sticky').position().top - 100;
  ...
  if (
    ...
    !$('.site-header').hasClass('navbar-sm')
  ) {
    var navbar_lg = false;
  ...
  if (
    $('.site-header').hasClass('navbar-transparent') &&
    $('.site-header').hasClass('sticky')
  ) {
  ...
  if (
    $('.site-header').hasClass('sticky') &&
    $('.site-header > .banner').length == 0
  ) {
    $('.site-header').css(
      'padding-top',
      $('.site-header > .navbar').height() + 30
    );
  }
  ...
  $('h1[id], h2[id], h3[id], h4[id], h5[id], h6[id]').each(function(
    ...
    var link =
      '<a href="#' + $(this).attr('id') + '">' + $(this).html() + '</a>';
    $(this).html(link);
  });
  ...
  $('pre').each(function(index, value) {
    $(this).prepend(
      '<a class="btn btn-sm btn-purple clipboard-copy" data-original-title="Copied!">Copy</a>'
    );
  });
  ...
  $('pre').each(function(index, value) {
    if (
      $(this).parents('.code-window').length ||
  ...
  $('.code-window').each(function(index, value) {
    ...
    if ($(this).children().length > 1) {
      topbar +=
        '<div class="languages"><div class="btn-group" data-toggle="buttons">';

      $(this)
        .children(':not(.prism-show-language)')
    ...
    $(this)
      .children()
      .wrapAll('<div class="window-content"></div>');
    $(this).prepend(topbar);
    ...
    $(this)
      ...
      .on('click', function() {
        ...
        window_content.children(':visible').fadeOut(200, function() {
          window_content
            .children(':not(.prism-show-language):eq(' + i + ')')
            .fadeIn(200);
        });
      });
  });
